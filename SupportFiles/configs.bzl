load("//SupportFiles:utils.bzl", "config_with_updated_linker_flags", "configs_with_config")
...
SHARED_CONFIGS = {
    "IPHONEOS_DEPLOYMENT_TARGET": "13.0",  # common target version
...
def bundle_identifier(name):
    return "br.com.fernandodelrio.%s" % name
...
def watch_binary_configs(name):
    config = {
        ...
        "WK_COMPANION_APP_BUNDLE_IDENTIFIER": bundle_identifier("GalleryApp"),
        "WK_APP_BUNDLE_IDENTIFIER": bundle_identifier("GalleryApp.WatchApp"),
